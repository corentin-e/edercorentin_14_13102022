        ...
        <div className='nameset_profil'>
            ...
            <div className='nameset_profil-inputs'>
                <div className='nameset_profil-input'>
                    ...
                    <input type="text" name="first name" id="first_name" {...register("firstName", { required: "Please enter a first name." })}/>
                </div>
                <span className='nameset_error-message'>{errors.firstName?.message}</span>
                <div className='nameset_profil-input'>
                    <label>Last Name</label>
                    <input type="text" name="last name" id="last_name" {...register("lastName", { required: "Please enter a last name." })}/>
                </div>
                <span className='nameset_error-message'>{errors.lastName?.message}</span>
                <div className='nameset_profil-input'>
                    <label>Date of Birth</label>
                    <input type="date" name="date of birth" id="birth_date" {...register("birthDate", { required: "Please enter a birthdate." })}/>
                </div>
